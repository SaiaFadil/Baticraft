...
class Edit_Produk_Kaos extends StatefulWidget {
  const Edit_Produk_Kaos({super.key});

  @override
  State<Edit_Produk_Kaos> createState() => Edit_Produk_KaosState();
}

class Edit_Produk_KaosState extends State<Edit_Produk_Kaos> {
//AWAL BACKEND
  String jsonProdukKaos = "{}";
  List<String> imagePaths = [];
  List<Map<String, dynamic>> listKaos = [];
  Future<void> showKaos() async {
    final response = await http.post(Server.url("showDetailKaos.php"),
...
//akhir generate kode
  ...
  Future<void> uploadData() async {
    var request =
        http.MultipartRequest('POST', Server.url("updateProdukKaos.php"));
          ...
          child: Card(
            ...
            child: Container(
              ...
              child: DropdownButton<String>(
                ...
                value: listKaos.isEmpty
                    ? _selectedJenisLengan
                    : listKaos[0]['jenis_lengan'],
