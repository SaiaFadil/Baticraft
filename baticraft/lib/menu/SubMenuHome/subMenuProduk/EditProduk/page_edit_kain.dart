...
class Edit_Produk_Kain extends StatefulWidget {
  const Edit_Produk_Kain({super.key});

  @override
  State<Edit_Produk_Kain> createState() => Edit_Produk_KainState();
}
                          ...
                          onPressed: () {
                            setState(() {
                              if (namaController.text.isEmpty) {
                                ...
                                DataTidakLengkap = true;
                              } else if (panjangKainController.text.isEmpty) {
                                DataTidakLengkap = true;
