...
import 'package:baticraft/menu/SubMenuHome/subMenuStatusPesanan/subMenuRiwayat/TabMenuRiwayat/DetailRiwayatTransaksi/page_detail_selesai.dart';
...
class RiwayatSelesai extends StatefulWidget {
  const RiwayatSelesai({super.key});
 
  @override
  State<RiwayatSelesai> createState() => _RiwayatSelesaiState();
}

class _RiwayatSelesaiState extends State<RiwayatSelesai> {
  ...
  Future<void> showRiwayat() async {
    final response =
        await http.get(Server.urlLaravel("showRiwayatSelesai"));
  ...
  Future showPencarian(String searchText) async {
    final response = await http.post(Server.urlLaravel("searchSelesai"),
                        ...
                        PageRouteBuilder(
                            pageBuilder:
                                (context, animation, secondaryAnimation) =>
                                    DetailSelesai(transactionId: id),
